...
>
  ...
  <div
    class="flex flex-row w-full relative pointer-events-none h-8 justify-center border"
  >
    <div>+ New Row</div>
  </div>
  ...
  {#each $game.layout as row, rowIndex}
    <div
      class="flex flex-row w-full relative md:p-4 pointer-events-none border"
